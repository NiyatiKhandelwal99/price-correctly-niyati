...
def show():
    ...
    bedroom_selection = st.selectbox('Bathrooms', bathroom_options)
    ...
    #comment out begin - Niyati
    # df['bedrooms'] = 1
   
    # model = load('random-forest-regressor-model.joblib')
    ...
    #comment out end - Niyati

    #Display price
    #st.markdown(f"# The average price for your property would be ${y_output}", unsafe_allow_html=True)
    # st.markdown(f"# The average price for your property would be 145")
    ...
    if st.button('Calculate'):
        ...
        # put the model processing code in here

        # Using st.success to make the result stand out
        st.success("### You should list your property for: $145 per night ! :moneybag:")